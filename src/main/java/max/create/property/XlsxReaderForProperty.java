...
public class XlsxReaderForProperty {
	...
	public static String getDefUnits() {
		row = sheet.getRow(PropertyMain.position);
		String defUnits = row.getCell(5).getStringCellValue();
		return defUnits;
	}
	
	public static String getFieldType() {
		row = sheet.getRow(PropertyMain.position);
		String fieldType = row.getCell(6).getStringCellValue();
		return fieldType;
	}
	
	public static String getDataType() {
		row = sheet.getRow(PropertyMain.position);
		String dataType = row.getCell(7).getStringCellValue();
		return dataType;
	}
	
	public static String getTextAlign() {
		row = sheet.getRow(PropertyMain.position);
		String textAlign = row.getCell(8).getStringCellValue();
		return textAlign;
	}
