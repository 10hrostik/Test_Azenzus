...
public class OpenManager {
	...
	public static void equipmentManager(WebDriver Az) throws InterruptedException {
		Az.findElement(By.xpath("//td[text() = 'Search']")).click();
        Az.findElement(By.xpath("//div[text() = 'Equipment']")).click();
        Thread.sleep(1000);
	}

	public static void documentManager(WebDriver Az) throws InterruptedException {
		Az.findElement(By.xpath("//td[text() = 'Search']")).click();
		Az.findElement(By.xpath("//div[text() = 'Document']")).click();
		Thread.sleep(2000);
	}

	public static void commentManager(WebDriver Az) throws InterruptedException{
		Az.findElement(By.xpath("//td[text() = 'Search']")).click();
		Az.findElement(By.xpath("//div[text() = 'Comment']")).click();
		Thread.sleep(2000);
	}
}
