...
public class Tools extends DriverConstructor {
    ...
    public String AdminPlantCheck(){
        try{
            driver.findElement(By.xpath("//div[text() = 'Administration']")).click();
            driver.findElement(By.xpath("//div[@role = 'menu']//div[text() = 'Plant']")).click();
            boolean expected[] = {true,true,true,true,true,false,true};
            Assert.assertArrayEquals(expected,checkIcons("//table[@height = '18px']//td[text() = 'Plant Search']",
    ...
    public String AdminUserCheck(){
        try{
            driver.findElement(By.xpath("//div[text() = 'Administration']")).click();
            driver.findElement(By.xpath("//div[@role = 'menu']//div[text() = 'User Profile']")).click();
            boolean expected[] = {true,false,false,true,true,false,true};
            Assert.assertArrayEquals(expected,checkIcons("//table[@height = '18px']//td[text() = 'User Profile']",
                    null,
                    null,
            ...
            driver.findElement(By.xpath("//div[contains(@eventproxy,'UserProfileWindow_0_cl')]")).click();
            return "Not needed";
        }catch(Exception e){
            System.out.println(e.getMessage());
            return "Not needed";
    ...
    private boolean[] checkIcons(String lable,String maximize,String minimize,String close,String searchBox ,String lowButton1,String lowButton2){
        ...
        try{
            ...
            if(lowButton1!=null)   if (driver.findElement(By.xpath(lowButton1)).isDisplayed()) isChecked[6] = true;
            if(lowButton2!=null)  if (driver.findElement(By.xpath(lowButton2)).isDisplayed()) isChecked[5] = true;
